...
const HeadingCards = () => {
  return (
    <>
    <main className='Heading-Cards h-full w-full mt-20 bg-cover justify-center ' style={{
                ...
                <div className='cards flex mt-16 justify-between px-60'>
                    <div className="card-1 p-3 bg-white h-56 w-44 rounded-3xl text-center">
                        <h1 className='text-[#98A5B7] '>STEP1</h1>
                    ...
                    <div className="card-2 p-3 bg-white h-56 w-44 rounded-3xl text-center">
                        <h1 className='text-[#98A5B7] '>STEP 2</h1>
                        <p className='text-base font-bold mt-2 text-[#333333]'>Your Heading Goes Here</p>
                        <p className='text-[#333333] mt-2 text-sm'>It is a long established fact that a reader will be distracted by the readable content of a page.</p>
                    </div>
                    <div className="card-3 p-3 bg-white h-56 w-44 rounded-3xl text-center">
                        <h1 className='text-[#98A5B7] '>STEP 3</h1>
                        <p className='text-base font-bold mt-2 text-[#333333]'>Your Heading Goes Here</p>
                        <p className='text-[#333333] mt-2 text-sm'>It is a long established fact that a reader will be distracted by the readable content of a page.</p>
                    </div>
                    <div className="card-4 p-3 bg-white h-56 w-44 rounded-3xl text-center">
                ...
                <div className='flex mt-8 justify-center pb-14'>
                    <Button className='bg-bt2 text-[#FFFFFF] border-none  rounded h-9 w-40' variant="outline">LETS GET STARTED</Button>
