            ...
            <div className='max-w-screen-2xl flex-col items-center p-10 m-auto flex justify-center  mblres:p-5'>
                ...
                <div className='w-full flex flex-wrap '>
                    ...
                    <div className='p-10 w-1/2 mblres:w-[100%] mblres:text-center mblres:mr-8'>
                        ...
                        <p className='text-[#81868E] py-12 text-xl ml-8 mblres:text-sm mblres:w-[100%]'>Business radically moves with the changes of technology and social media. We want to help create all-around services that will help create an automated workflow across all your current solutions and work streams in which we can create custom solutions or manage your current ones that will help deliver success for your customers.</p>
