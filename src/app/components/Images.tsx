  ...
  return (
    ...
    <div className='flex justify-center mt-9'>
      ...
      <div className="flex flex-wrap justify-evenly gap-4 mt-8">
        <div className="w-14 sm:w-16 mt-3 opacity-10"><Image alt='' src={logo11} /></div>
        <div className="w-14 sm:w-16 opacity-35"><Image alt='' src={logo12} /></div>
        <div className="w-16 sm:w-20 mt-4 opacity-25"><Image alt='' src={logo13} /></div>
        <div className="w-14 sm:w-16 mt-3"><Image alt='' src={logo14} /></div>
        ...
        <div className="w-14 sm:w-16 mt-3 opacity-50"><Image alt='' src={logo20} /></div>
      </div>
    </>
  )
}
