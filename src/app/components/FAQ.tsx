        ...
        <main className='Accordion relative pb-64 flex justify-center bg-[#F2F7FF] px-4 md:px-6 lg:px-8'>
            <div className="w-full max-w-[38rem] bg-yell mx-auto">
                ...
                <div className="mb-2">
                    ...
                    >
                        <div className='flex items-center'>
                            <span className='text-[#0055FF] font-medium text-2xl'>01</span>
                    ...
                    {expandedSection === 'section1' && (
                        <div id="section1" className="accordion-content pl-4 pr-4 py-2 text-[#666666] text-xs bg-white rounded-b-lg shadow-md">
                ...
                <div className="mb-2">
                    ...
                    >
                        <div className='flex items-center'>
                            <span className='text-[#81868E] font-medium text-2xl'>02</span>
                    ...
                    {expandedSection === 'section2' && (
                        <div id="section2" className="accordion-content pl-4 pr-4 py-2 text-[#666666] text-xs bg-white rounded-b-lg shadow-md">
                ...
                <div className="mb-2">
                    ...
                    >
                        <div className='flex items-center'>
                            <span className='text-[#81868E] font-medium text-2xl'>03</span>
                    ...
                    {expandedSection === 'section3' && (
                        <div id="section3" className="accordion-content pl-4 pr-4 py-2 text-[#666666] text-xs bg-white rounded-b-lg shadow-md">
                ...
                <div className="mb-2">
                    ...
                    >
                        <div className='flex items-center'>
                            <span className='text-[#81868E] font-medium text-2xl'>04</span>
                    ...
                    {expandedSection === 'section4' && (
                        <div id="section4" className="accordion-content pl-4 pr-4 py-2 text-[#666666] text-xs bg-white rounded-b-lg shadow-md">
                ...
                <div className="mb-2">
                    ...
                    >
                        <div className='flex items-center'>
                            <span className='text-[#81868E] font-medium text-2xl'>05</span>
                    ...
                    {expandedSection === 'section5' && (
                        <div id="section5" className="accordion-content pl-4 pr-4 py-2 text-[#666666] text-xs bg-white rounded-b-lg shadow-md">
